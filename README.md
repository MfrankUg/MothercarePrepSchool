...
This project is a modern, responsive website built with Next.js and TypeScript for Mothercare Preparatory School located in Kasese, Uganda. It is designed to present the school’s academic structure, admissions process, and student life in a professional and engaging way.
...
1. Review the full design mockups and prototype in Figma
2. Understand layout structure and navigation
3. Identify components (Navbar, Hero, Sections, Footer)
4. Break down UI into reusable components
5. Implement components in the codebase
6. Ensure responsiveness across devices
7. Maintain consistency with colors, fonts, and spacing
...
[https://github.com/MfrankUg/MothercarePrepSchool](https://github.com/MfrankUg/MothercarePrepSchool)
...
Since this is a Next.js project, install the required packages using npm or yarn:
